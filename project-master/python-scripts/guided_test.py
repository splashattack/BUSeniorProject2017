...
* send_offset_velocity - Sets velocity components using SET_POSITION_TARGET_GLOBAL_INT command
"""
...
send_offset_velocity(0,0.5,0,4)
send_offset_velocity(0,0,0,1)

send_offset_velocity(0.5,0,0,4)
send_body_offset_velocity(0,0,0,1)

send_offset_velocity(-0.5,-0.5,0,4)
send_offset_velocity(0,0,0,1)
